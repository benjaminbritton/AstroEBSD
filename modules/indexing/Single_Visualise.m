...
s4=subplot(2,2,4);
Plot_EBSPAnnotated( EBSP_cor,EBSD_geometry,nhat_gnom,MapOut.GDetector(:,:,y_co,x_co),Crystal_UCell{num_P},Crystal_LUT{num_P}.family_norm_list,s4);
