...
run('C:\Users\billy\Documents\GitHub\AstroEBSD_v2\start_AstroEBSD.m');
run('C:\Users\billy\Documents\MATLAB\mtex-5.8.0\startup.m');

location_astro='C:\Users\billy\Documents\GitHub\AstroEBSD_v2\';
%% load the pattern + Figure 1


pat1=double(flipud(imread('stitched_flat_gaus.tif'))); % this is the demo TKP
figure;
...
% figure;
% imagesc(stereo_xl,stereo_yl,pat_map);
% colormap('gray')
% hold on;
...
%check if the blue is within the yellow